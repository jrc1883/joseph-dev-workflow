...
description: "Use when you want to create a project-specific morning health check command - analyzes the project's tech stack and generates customized health checks for services, databases, and domain-specific validations"
---
